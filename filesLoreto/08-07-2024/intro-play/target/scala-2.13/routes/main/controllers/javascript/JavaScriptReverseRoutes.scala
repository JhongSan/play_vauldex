...
package controllers.javascript {
  ...
  class ReverseHomeController(_prefix: => String) {
    ...
    // @LINE:11
    def loreto: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.HomeController.loreto",
      """
        function(mf0) {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "yeah/loreto/" + encodeURIComponent((""" + implicitly[play.api.mvc.PathBindable[String]].javascriptUnbind + """)("mf", mf0))})
        }
      """
    )
